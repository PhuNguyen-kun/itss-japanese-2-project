import { CheckCircle2, Circle, Clock, TrendingDown, Lock } from "lucide-react";
import { Milestone } from "../utils/roadmapGenerator";
              ...
              >
                ...
                {task.status === "active" && (
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <button className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 rounded-lg font-bold hover:from-green-600 hover:to-emerald-700 transition-all">
