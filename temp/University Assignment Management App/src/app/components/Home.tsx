...
import { getAssignments } from "../utils/roadmapGenerator";
...
export function Home() {
  ...
  const totalPointsAvailable = 2500;
      ...
      <div className="grid grid-cols-3 gap-6">
                    ...
                    {allTasks.slice(0, 6).map((task) => {
                      ...
                      return (
                        <tr
                          ...
                          onClick={() => window.location.href = `/roadmap/${task.assignmentId}`}
                        >
        ...
        <div className="space-y-6">
          ...
          {assignments.length > 0 && (
            <Link to={`/roadmap/${assignments[0].id}`}>
