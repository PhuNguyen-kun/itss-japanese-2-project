...
import { getAssignment, getAssignments } from "../utils/roadmapGenerator";
...
export function RoadmapView() {
          ...
          <div className="grid grid-cols-2 gap-6">
            {assignments.map((assignment) => {
              ...
              return (
                <div
                  key={assignment.id}
                  onClick={() => navigate(`/roadmap/${assignment.id}`)}
  ...
  const roadmap = getAssignment(parseInt(assignmentId || "0"));
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <div className="flex items-center space-x-3 text-sm">
              <span className="px-3 py-1 bg-gray-100 rounded-lg capitalize font-semibold">
                {roadmap.difficulty}
              </span>
